...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.GetCoupons":
		if e.complexity.Query.GetCoupons == nil {
			break
		}

		args, err := ec.field_Query_GetCoupons_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) field_Mutation_UpdateCoupon_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg1, err = ec.unmarshalNCouponInput2crapiᚗcommunityᚋgraphqlᚗgrpcᚋgraphᚋmodelᚐCouponInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_UpdatePost_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg1, err = ec.unmarshalNPostInput2crapiᚗcommunityᚋgraphqlᚗgrpcᚋgraphᚋmodelᚐPostInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_DeletePost(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeletePost(rctx, fc.Args["postsID"].([]string))
	})
	if err != nil {
		ec.Error(ctx, err)
	}
...
func (ec *executionContext) _Query_GetCoupons(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_GetCoupons(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	res := resTmp.([]*model.Coupon)
	fc.Result = res
	return ec.marshalNCoupon2ᚕᚖcrapiᚗcommunityᚋgraphqlᚗgrpcᚋgraphᚋmodelᚐCouponᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Query_GetCoupons(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_GetCoupons_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) unmarshalInputCouponInput(ctx context.Context, obj interface{}) (model.CouponInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "coupon_code":
			...
			it.CouponCode, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "amount":
...
func (ec *executionContext) unmarshalInputUserInput(ctx context.Context, obj interface{}) (model.UserInput, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "profile_pic_url":
			...
			it.ProfilePicURL, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "created_at":
	...
	for i, field := range fields {
		...
		case "GetCoupons":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Query_GetCoupons(ctx, field)
				return res
			}
...
func (ec *executionContext) marshalNCoupon2ᚕᚖcrapiᚗcommunityᚋgraphqlᚗgrpcᚋgraphᚋmodelᚐCouponᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Coupon) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCoupon2ᚖcrapiᚗcommunityᚋgraphqlᚗgrpcᚋgraphᚋmodelᚐCoupon(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
